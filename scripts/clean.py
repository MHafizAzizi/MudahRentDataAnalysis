...
def clean_rooms(rooms):
    ...
    try:
        ...
        # Not numeric: a valid categorical label (e.g. "More than 10",
        # "Studio"). Keep verbatim rather than nulling — these are real data.
        return s
...
def clean_raw_files():
    ...
    # both would double-count. (load_to_db upserts by ads_id regardless.)
    raw_files = [
